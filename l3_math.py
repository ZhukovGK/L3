...
round_sqr = user_radius ** user_radius * PI # площадь круга равна квадрату радиуса на число пи
...
print("Сторона описанного вокруг окружности восьмиугольника = ", outer_triange_side, "см и ", outer_triange_side / 100,"м")